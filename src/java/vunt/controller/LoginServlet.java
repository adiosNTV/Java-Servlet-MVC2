...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            AccountDTO validUser = dao.getAccountByUsernameAndPassword(username, password);
            if (validUser != null) {
//                url = MyAppConstants.LoginFeatures.SEARCH_ACTION;
                //if validate, create cookie for the next time login
                Cookie cookie = new Cookie(username, password);
                cookie.setMaxAge(60*3);
                response.addCookie(cookie);
                url = MyAppConstants.LoginFeatures.SEARCH_ACTION; //create new session
